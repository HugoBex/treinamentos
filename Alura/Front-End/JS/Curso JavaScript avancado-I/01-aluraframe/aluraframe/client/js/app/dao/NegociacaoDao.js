            ...
            _export('NegociacaoDao', NegociacaoDao = function () {
                ...
                _createClass(NegociacaoDao, [{
                    ...
                    value: function remover(negociacao) {
                        ...
                        return new Promise(function (resolve, reject) {
                            var request = _this2._connection.transaction([_this2._store], "readwrite").objectStore(_this2._store).delete(negociacao);
                    ...
                    key: 'apagaTodos',
                    value: function apagaTodos(negociacao) {
                        var _this3 = this;
                    ...
                    value: function listarTodos() {
                        ...
                        return new Promise(function (resolve, reject) {
                            var cursor = _this4._connection.transaction([_this4._store], 'readwrite').objectStore(_this4._store).openCursor();

                            var negociacoes = [];

                            cursor.onsuccess = function (e) {
                                var cursorAtual = e.target.result;
                                if (cursorAtual) {
                                    var resultSet = cursorAtual.value;
                                    negociacoes.push(new Negociacao(resultSet._data, resultSet._quantidade, resultSet._valor));
